         ...
         <div className="flex gap-4">
            <div className="relative">
               ...
               <input 
                  ...
                  className="pl-14 pr-6 py-4 bg-royal-dark/40 backdrop-blur-md/5 border border-gold/10 text-[0.6rem] font-black uppercase tracking-[0.2em] w-80 outline-none focus:border-gold/30 transition-all"
               />
            </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {designers.map((designer) => (
          <motion.div 
            ...
            className="bg-transparent border border-gold/10 group cursor-pointer overflow-hidden p-8"
            onClick={() => setSelectedDesigner(designer)}
          >
             <div className="aspect-video bg-royal-dark/40 backdrop-blur-md/5 mb-10 overflow-hidden relative">
                ...
                <div className="absolute bottom-6 left-6">
                   <span className="px-4 py-2 bg-royal-dark/40 backdrop-blur-md/5 border border-gold/20 text-[0.5rem] font-black uppercase tracking-widest text-white/60 group-hover:bg-gold group-hover:text-premium-white group-hover:border-gold transition-all">View Collection</span>
                </div>
             </div>
             ...
             <div className="pt-8 border-t border-gold/10 grid grid-cols-2 gap-8 text-[0.6rem] font-black uppercase tracking-widest">
                <div>
         ...
         {selectedDesigner && (
           ...
           >
              <motion.div 
                ...
                animate={{ x: 0 }}
                exit={{ x: '100%' }}
                className="w-full max-w-4xl h-screen bg-[#0e0e0e] border-l border-gold/20 overflow-y-auto"
              >
                 <div className="sticky top-0 bg-[#0e0e0e]/80 backdrop-blur-3xl p-12 border-b border-gold/10 flex justify-between items-center z-10">
                    <div className="flex items-center space-x-6">
                       <span className="text-gold font-black uppercase tracking-[0.4em] text-[0.6rem]">Guild Member Registry</span>
                       <div className="w-2 h-2 rounded-full bg-green-500" />
                    </div>
                    <button onClick={() => setSelectedDesigner(null)} className="p-4 bg-royal-dark/40 backdrop-blur-md/5 text-white/40 hover:text-white transition-colors"><Plus size={24} className="rotate-45" /></button>
                 </div>

                 <div className="p-12 md:p-20 space-y-20">
                    <div className="flex flex-col md:flex-row gap-16">
                       <div className="md:w-1/3 aspect-[3/4] bg-royal-dark/40 backdrop-blur-md/5 border border-gold/10 overflow-hidden">
                       ...
                       <div className="md:w-2/3 space-y-10">
                          ...
                          <div className="flex gap-6 pt-10">
                             <button className="flex-1 py-6 bg-gold text-premium-white font-black uppercase tracking-[0.4em] text-[0.7rem] hover:bg-royal-dark/40 backdrop-blur-md transition-all">Edit Registry</button>
                             <button className="px-10 py-6 border border-gold/20 text-white/40 hover:text-white hover:border-white transition-all"><ExternalLink size={18} /></button>
                          </div>
                       </div>
                    </div>
                    ...
                    <div className="space-y-12">
                       ...
                       <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
                          {[1,2,3,4,5,6].map((i) => (
                            <div key={i} className="aspect-square bg-royal-dark/40 backdrop-blur-md/5 group relative cursor-pointer overflow-hidden">
                    ...
                    <div className="p-12 bg-royal-dark/40 backdrop-blur-md/5 border border-gold/10 space-y-12">
                       ...
                       <div className="space-y-6">
                          {[
                            ...
                            <div key={i} className="flex flex-col md:flex-row justify-between items-start md:items-center p-8 bg-transparent border border-gold/10 hover:border-gold/30 transition-all group">
                               ...
                               <div className="flex flex-col md:flex-row items-start md:items-center gap-6">
                                  ...
                                  <button className={`px-8 py-3 text-[0.55rem] font-black uppercase tracking-[0.4em] ${slot.status === 'Reserved' ? 'bg-gold text-premium-white' : 'border border-gold/20 text-white hover:border-gold hover:text-gold transition-all'}`}>
