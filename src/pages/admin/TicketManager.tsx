    ...
    <div className="space-y-12">
      ...
      <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end gap-12">
         ...
         <div className="flex gap-4">
            <button className="px-10 py-4 bg-white/5 border border-white/5 text-[0.6rem] font-black uppercase tracking-[0.4em] text-white/40 hover:text-white transition-all flex items-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
         {ticketTypes.map((ticket, i) => (
           <div key={i} className="bg-[#0a0a0a] border border-white/5 p-12 group hover:border-gold/30 transition-all">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
         ...
         <div className="lg:col-span-8 bg-[#0a0a0a] border border-white/5 p-12">
            <div className="flex justify-between items-center mb-16 px-4">
               ...
               <div className="flex items-center space-x-8">
                  <div className="relative">
                     ...
                     <input type="text" placeholder="TX-ID / NAME..." className="pl-10 pr-6 py-2 bg-white/5 border border-white/5 text-[0.55rem] font-black uppercase tracking-[0.1em] outline-none" />
                  </div>
               </div>
            </div>

            <div className="space-y-6">
               <div className="grid grid-cols-6 gap-6 px-4 py-4 text-[0.5rem] font-black uppercase tracking-[0.4em] text-white/20 border-b border-white/5">
               ...
               {recentTransactions.map((tx, i) => (
                 <div key={i} className="grid grid-cols-6 gap-6 px-4 py-8 bg-white/[0.01] hover:bg-white/[0.03] transition-all group items-center">
            ...
            <button className="w-full mt-12 py-5 border border-white/5 text-[0.6rem] font-black uppercase tracking-[0.4em] text-white/20 hover:text-white transition-all uppercase">Load Historical Registry (2025 Archive)</button>
         </div>
         ...
         <div className="lg:col-span-4 space-y-12">
            ...
            <div className="bg-gold p-12 text-[#0a0a0a] space-y-12 relative overflow-hidden">
               ...
               <button className="w-full py-5 bg-black text-white text-[0.6rem] font-black uppercase tracking-[0.6em] hover:bg-white hover:text-black transition-all">Launch Auth Console</button>
            </div>
         </div>
      </div>
    </div>
